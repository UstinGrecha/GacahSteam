...
export const ru: Messages = {
  ...
  pack: {
    ...
    premium: "Премиум",
    hintSummary:
      "Бесплатных стандартных открытий сейчас: {{freeTotal}} (до {{freeMax}} в сутки плюс начисление каждый час). Каждые {{pity}} паков подряд без rare+ — следующий даёт редкую или выше.",
